...
execute as @a[team=yellow] if score @s inDeployBox matches 1 unless score @s inMap matches 1 run scoreboard players set @s isDeploying 1
scoreboard players set #yellow isDeploying 0
execute as @a[team=yellow] if score @s isDeploying matches 1 run scoreboard players set #yellow isDeploying 1
