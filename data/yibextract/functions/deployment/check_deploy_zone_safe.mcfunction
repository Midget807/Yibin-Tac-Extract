...
execute if entity @a[x=-171,y=-27,z=86,dx=21,dy=10,dz=4] run scoreboard players set @e[type=minecraft:armor_stand, tag=MapDeployZone, tag=StationSouth] safeMapDeployZones 0
...
execute unless entity @a[x=-171,y=-27,z=86,dx=21,dy=10,dz=4] run scoreboard players set @e[type=minecraft:armor_stand, tag=MapDeployZone, tag=StationSouth] safeMapDeployZones 1
